...
public class MessageUtils {
    ...
    private static final String PREFIX = ChatColor.DARK_GRAY + "" + '\u2502' + " " + ChatColor.YELLOW + ChatColor.BOLD + "Hive" + ChatColor.RED + ChatColor.BOLD + "Ranks" + ChatColor.DARK_GRAY + "" + '\u2502' + " " + ChatColor.RESET;
